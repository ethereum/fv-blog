...
Intuitively states that the partial result calculated so far (`r`), multipled by the remaining
...
This is obviously quite a lot of work to prove what may seem like a simple and obvious fact it is
